    ...
    match stage {
        ...
        "D003_8" => match room {
            Some(0) => {
                ...
                bzs.lay[3].stag.add_sc_chang(&mut highest_used_id)
                    .set_pos(0f32, 0f32, 0f32)
                    .set_size(10000f32, 10000f32, 10000f32)
                    .set_scen_link(3)
                    .set_trigscenefid(0x40);
                let mut mobj = SOBJ::default();
                let obj = &mut mobj;
        ...
        "F020" => match room {
            Some(0) => {
                ...
                bzs.lay[0].stag.modify_by_id(0xFC8B)?.as_sc_chang().set_untrigstoryfid(0x7FF);
